                            ...
                            <li style="list-style: none;" class='sub-menu'><a
                                ...
                                <ul id="dragitemslistcontainer">
                                    ...
                                    <li>
                                        ...
                                        <input class="form-control m-1" type="number" id="width_vid" style="width: 100%"
                                            placeholder="add Height of video iframe">
                                        <input class="form-control m-1" type="number" id="height_vid" style="width: 100%"
    ...
    <div id="myModalElement" class="modalnya">
        ...
        <div class="modal-content">
            ...
            <div
                ...
                <input class="form-control" placeholder="in px" type="text" name="src_element" id="src_element">
                <label for="width_element">Width</label>
                <input class="form-control" placeholder="in px" type="text" name="width_element" id="width_element">
                ...
                <input class="form-control" type="text" name="margin_element" id="margin_element"
                    placeholder="fill with format : t r b l dont forget with px or auto">
